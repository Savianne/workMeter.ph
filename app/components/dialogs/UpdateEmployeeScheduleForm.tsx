...
import { useUpdateSchedule } from '@/app/admin/scheduler/SchedulerTable';
        ...
        <React.Fragment>
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button sx={{background: "linear-gradient(90deg, var(--primaryAppColor) 0%, var(--secondaryAppColor) 100%)", color: "#fff"}} loadingPosition='end' loading={isLoading} variant='contained' autoFocus onClick={handleUpdate}>
                        Update
                    </Button>
                </DialogActions>
            </BootstrapDialog>
