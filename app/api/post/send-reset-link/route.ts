...
export async function POST(req:NextRequest) {
    ...
    try {
        if(!(formData.email && formData.userName && formData.uid)) throw "Incomplete data";
        ...
        const fpToken = jwt.sign({account: {email: formData.email, userName: formData.userName, uid: formData.uid}, expDate: expirationDate }, access_token_secret, { expiresIn });
        
        const resetPassLink = `http://localhost:3001/reset-password/${fpToken}/`;
                                                                ...
                                                                <table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                                    <tr>
                                                                        <td class="pad" style="text-align:center;width:100%;">
                                                                            <h1 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 23px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Hello ${formData.userName},</span></h1>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="pad">
                                                                            <div style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
                                                                                <p style="margin: 0;">We received a request to reset your password for your WorkMeter account. To proceed with the password reset, please click on the button below:</p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
        ...
        await db.query<ResultSetHeader>(`
            INSERT INTO next_reset_password_link_datetime_request (uid, next_req_datetime) VALUES (?, ?)
                ON DUPLICATE KEY UPDATE
                    next_req_datetime = VALUES(next_req_datetime)
            `, [formData.uid, expirationDate]);
        
        const resObj: TResponseObject<{ success: boolean, next_req_time: Date }> = {
            data: {success: true, next_req_time: expirationDate}
        }
