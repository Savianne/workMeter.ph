// 'use client' 
// import { ITimesheetFromDB } from '../types/timesheet'
...
//     activeTimesheet: ITimesheetFromDB,
//     setTimesheets: (newList: ITimesheetFromDB[]) => void
// }

// const TimesheetProvider = createContext<ITimesheetContext | undefined>(undefined)

// export function useTimesheetProvider() {
